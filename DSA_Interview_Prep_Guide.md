...
### Key Observations
- The single most important step is defining the state clearly in words before writing any code: "dp[i] represents ___." If you can't state it in one sentence, you're not ready to code it.
